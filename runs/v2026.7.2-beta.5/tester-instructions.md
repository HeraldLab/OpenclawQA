# Tester Instructions — OpenClaw `v2026.7.2-beta.5`

Generated: `2026-07-28T03:30:24Z`
Run folder: https://github.com/HeraldLab/OpenclawQA/tree/main/runs/v2026.7.2-beta.5
Upstream release: https://github.com/openclaw/openclaw/releases/tag/v2026.7.2-beta.5
Report results: https://github.com/HeraldLab/OpenclawQA/issues/new/choose
Deadline: **6 hours after packet receipt**

## Target

Test OpenClaw beta release `v2026.7.2-beta.5`. This is a manual QA pass for release confidence, not a general support thread.
...
- Status: `NOT_CHECKED` — inspect `#clawtributors` before dispatch.

Default card shape is 6–8 checks:

1. Install/upgrade to `v2026.7.2-beta.5`.
...
1. **Install or upgrade** to `v2026.7.2-beta.5` from your normal path.
