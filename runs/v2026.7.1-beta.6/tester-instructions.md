# Tester Instructions — OpenClaw `v2026.7.1-beta.6`

Generated: `2026-07-13T02:00:16Z`
Run folder: https://github.com/HeraldLab/OpenclawQA/tree/main/runs/v2026.7.1-beta.6
...
Test OpenClaw beta release `v2026.7.1-beta.6`. This is a manual QA pass for release confidence, not a general support thread.
...
1. Install/upgrade to `v2026.7.1-beta.6`.
...
1. **Install or upgrade** to `v2026.7.1-beta.6` from your normal path.
