# Tester Instructions — OpenClaw `v2026.7.2-beta.7`

Generated: `2026-08-02T08:30:16Z`
Run folder: https://github.com/HeraldLab/OpenclawQA/tree/main/runs/v2026.7.2-beta.7
...
Test OpenClaw beta release `v2026.7.2-beta.7`. This is a manual QA pass for release confidence, not a general support thread.
...
1. Install/upgrade to `v2026.7.2-beta.7`.
...
1. **Install or upgrade** to `v2026.7.2-beta.7` from your normal path.
