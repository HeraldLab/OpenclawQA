# Tester Instructions — OpenClaw `v2026.7.2-beta.6`

Generated: `2026-08-01T06:00:59Z`
Run folder: https://github.com/HeraldLab/OpenclawQA/tree/main/runs/v2026.7.2-beta.6
Upstream release: https://github.com/openclaw/openclaw/releases/tag/v2026.7.2-beta.6
Report results: https://github.com/HeraldLab/OpenclawQA/issues/new/choose
Deadline: **6 hours after packet receipt**

## Target

Test OpenClaw beta release `v2026.7.2-beta.6`. This is a manual QA pass for release confidence, not a general support thread.
...
1. Install/upgrade to `v2026.7.2-beta.6`.
...
1. **Install or upgrade** to `v2026.7.2-beta.6` from your normal path.
