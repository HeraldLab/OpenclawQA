# Tester Instructions — OpenClaw `v2026.6.5-beta.6`
...
Test OpenClaw beta release `v2026.6.5-beta.6`. This is a manual QA pass for release confidence, not a general support thread.
...
1. Install/upgrade to `v2026.6.5-beta.6`.
...
1. **Install or upgrade** to `v2026.6.5-beta.6` from your normal path.
