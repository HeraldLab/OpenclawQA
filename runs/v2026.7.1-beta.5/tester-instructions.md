# Tester Instructions — OpenClaw `v2026.7.1-beta.5`

Generated: `2026-07-11T11:00:35Z`
Run folder: https://github.com/HeraldLab/OpenclawQA/tree/main/runs/v2026.7.1-beta.5
...
Test OpenClaw beta release `v2026.7.1-beta.5`. This is a manual QA pass for release confidence, not a general support thread.
...
1. Install/upgrade to `v2026.7.1-beta.5`.
...
1. **Install or upgrade** to `v2026.7.1-beta.5` from your normal path.
