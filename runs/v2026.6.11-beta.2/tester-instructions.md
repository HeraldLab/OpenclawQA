# Tester Instructions — OpenClaw `v2026.6.11-beta.2`

Generated: `2026-06-28T23:30:15Z`
Run folder: https://github.com/HeraldLab/OpenclawQA/tree/main/runs/v2026.6.11-beta.2
...
Test OpenClaw beta release `v2026.6.11-beta.2`. This is a manual QA pass for release confidence, not a general support thread.
...
1. Install/upgrade to `v2026.6.11-beta.2`.
...
1. **Install or upgrade** to `v2026.6.11-beta.2` from your normal path.
