# Tester Instructions — OpenClaw `v2026.6.6-beta.1`

Generated: `2026-06-10T18:00:26Z`
Run folder: https://github.com/HeraldLab/OpenclawQA/tree/main/runs/v2026.6.6-beta.1
...
Test OpenClaw beta release `v2026.6.6-beta.1`. This is a manual QA pass for release confidence, not a general support thread.
...
1. Install/upgrade to `v2026.6.6-beta.1`.
...
1. **Install or upgrade** to `v2026.6.6-beta.1` from your normal path.
