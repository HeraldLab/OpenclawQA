# Tester Instructions — OpenClaw `v2026.6.1-beta.2`

Generated: `2026-06-01T22:00:14Z`  
...
Test OpenClaw beta release `v2026.6.1-beta.2`. This is a manual QA pass for release confidence, not a general support thread.
...
1. **Install or upgrade** to `v2026.6.1-beta.2` from your normal path.
