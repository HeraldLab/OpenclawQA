# Tester Instructions — OpenClaw `v2026.8.1-beta.3`

Generated: `2026-08-24T05:00:58Z`
Run folder: https://github.com/HeraldLab/OpenclawQA/tree/main/runs/v2026.8.1-beta.3
...
Test OpenClaw beta release `v2026.8.1-beta.3`. This is a manual QA pass for release confidence, not a general support thread.
...
1. Install/upgrade to `v2026.8.1-beta.3`.
...
1. **Install or upgrade** to `v2026.8.1-beta.3` from your normal path.
